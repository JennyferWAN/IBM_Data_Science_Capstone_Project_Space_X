# INFO Terminal : (https://stackoverflow.com/questions/64124931/how-to-fix-locking-failed-in-pipenv)
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        pie_df = pie_df.groupby(['Launch Site','class']).size().reset_index(name = 'Total class')
        fig = px.pie(pie_df,
            values = 'Total class',
            names='class', 
